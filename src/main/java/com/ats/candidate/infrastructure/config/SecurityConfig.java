    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .hasAnyAuthority("RECRUITER_READ", "CANDIDATE_READ", "ROLE_ADMIN", "ROLE_RECRUITER")
                        .requestMatchers(HttpMethod.GET, "/api/candidates/*/attachments/*/content")
                        .hasAnyAuthority("RECRUITER_READ", "CANDIDATE_READ", "ROLE_ADMIN", "ROLE_RECRUITER")
                        .requestMatchers(HttpMethod.GET, "/api/candidates/*/status-history")
                        .hasAnyAuthority("RECRUITER_READ", "CANDIDATE_READ", "ROLE_ADMIN", "ROLE_RECRUITER")
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/candidates/*/attachments/*/parse")
